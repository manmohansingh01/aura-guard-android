...
if "$cygwin" || "$msys" ; then
    ...
    for arg do
        ...
        # unlike a while loop, the number of iterations is fixed at this point.
        append=$arg
    done
fi
...
#     treated as a fragment of the command line, and will end up being passed to the JVM as is.
